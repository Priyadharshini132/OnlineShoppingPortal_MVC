			...
			<div class="container">
				...
				<div class="nav-collapse collapse navbar-responsive-collapse">
					<ul class="nav navbar-nav">
						...
						<li><a href="advTemp.jsp">Adv Search</a></li>
					</ul>
					<!-- End of nav ul -->
							...
							<div class="row">
								...
								<div class="col-sm-4">
									...
									<form action="advsearch2" method="get">
										...
										<br>
											<strong>Brand:</strong><br>
										<br> <select name="key11">
											<option selected="selected" value="NONE">- select -</option>
											<option value="brand asc">ASC</option>
											<option value="brand desc">DESC</option>
										</select><br><br> <strong>Price:</strong><br>
										<br> <select name="key12">
											<option selected="selected" value="NONE">- select -</option>
											<option value="price asc">Low to High</option>
											<option value="price desc">High to Low</option>
										</select><br><br> <strong>Color:</strong><br>
										<br> <select name="key13">
											<option selected="selected" value="NONE">- select -</option>
