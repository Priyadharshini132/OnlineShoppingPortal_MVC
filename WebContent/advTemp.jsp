						...
						<div class="well">
							...
							<div class="row">
								...
								<div class="col-sm-4">
									...
									<form action="advsearch1" method="get" id="keyword1"
										name="keyword1" enctype="application/x-www-form-urlencoded">
										<strong>Select Category</strong> <select class="form-control"
											id="select1" onchange="changeTest()" name="keyword">
