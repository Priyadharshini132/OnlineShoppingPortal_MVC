				...
				<div class="column col-sm-9" id="main">
					...
					<div class="well">
						<div class="row">
							...
							<div class="col-sm-4">
								<a class="btn btn-small btn-primary" id="alertMe" href="">Want
									to refine your search?</a>
							</div>
							<div class="col-sm-4"></div>
						...
						<div class="row" id="featuresHeading">
							<div class="col-12">
								...
								<h4>
									<small>Sorry, No match found for your search!!<br>
										Please enter some other text!!
									</small>
								</h4>
							</div>
							<!-- End col-12 -->
