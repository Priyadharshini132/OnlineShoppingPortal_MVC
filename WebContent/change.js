$(function() {
	...
	$("#_cat").change(function() {
		...
		if ($thisOption.val() == valueToCompare0) {
			...
			/*
			 * $.ajax({ url:'advsearch1', type:'post', datatype:'text', data:
			 * {keyword:"men"}
			 * 
			 * });
			 */
			...
			/*
			 * $('#subcat').hide(); $('#_heel').hide(); $('#_heel1').hide();
			 * $('#_type20').hide(); $('#_type21').hide(); $('#_type22').hide();
			 * $('#_sort').hide();
			 */
			...
			// makeEnable();
			/*
			 * $('#subcat').show(); $('#_heel').hide(); $('#_heel1').hide();
			 * $('#_type20').show(); $('#_sort').show(); $('#_type21').hide();
			 * $('#_type22').hide();
			 */
