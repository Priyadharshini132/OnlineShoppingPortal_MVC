...
<%@ page import="org.team4.semistercoder.Navigator_Controller"%>
...
Navigator_Controller nv=new Navigator_Controller();
int size1=0;
 

ArrayList<Navigator_Controller> basicsearch=nv.SendResult();
String token=nv.svalue();
int nrow=nv.numrow();
...
Iterator<Navigator_Controller> iterator = basicsearch.iterator();
%>
					...
					<div class="well">
						...
						<div class="row" id="featuresHeading">
							<div class="col-12">
								...
								<br>
								<h4>
									Your search for "<%=token%>" has returned "<%=nrow%>" results!!
								</h4>
							</div>
							<!-- End col-12 -->
						</div>
						...
						<%
							//BasicSearch bs=new BasicSearch();
									...
									{
						            			Navigator_Controller basicsearch1=(Navigator_Controller)iterator.next();
