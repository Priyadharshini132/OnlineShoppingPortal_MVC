...
public class AdvancedSearch_Controller2 extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request,
		...
		if (word1.equals("MEN")) {
			...
			/*
			 * if(price.length>1) { pricecon=price[0]; for (int
			 * i=1;i<price.length; i++){ pricecon=pricecon+" "+price[i]; }
			 * System.out.println(pricecon); } else{pricecon=price[0];
			 * System.out.println(pricecon);}
			 */

			word = word1 + " " + brandcon + " " + itemcon + " " + colorcon
					+ " " + matcon + " " + sizecon;
			System.out
					.println("all keywords together in AdvanSearch_Controller:");
