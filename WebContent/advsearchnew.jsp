				...
				<div class="column col-sm-3" id="sidebar">
					...
					<div>
						<ul class="nav nav-tabs nav-stacked" id="">
							...
							<li><a href="results.html">WOMENS &#9662;</a>
								<ul>
									<li id="sublinks"><a href="results.html">CASUALS</a></li>
									<li id="sublinks"><a href="results.html">FLIPFLOPS</a></li>
									<li id="sublinks"><a href="results.html">SNEAKERS</a></li>
					...
					<div class="">
						<div class="well">
							<div class="page-header">
								<h1>
									Advance Search <small> Narrow your Search</small>
								</h1>
							</div>
							<!-- End of page-header -->
							...
							<div class="row">
								...
								<div class="col-sm-4">
									<form name="abc" action="advsearch1" method="post" id="formid">
										...
										<div class="row">
											<label for="_cat" id="_cat1">Category:</label> <select
												class="form-control" id="_cat" name="keyword">
											...
											<div id="subcat">
												<div id="_brand2">
													<label for="_brand" id="_brand1">Brand:</label> <select
														class="form-control" id="_brand">
												...
												<div id="_item1">
													<label for="s-state" id="_item1">Item:</label> <select
														class="form-control" id="_item">
														<option value="">- select -</option>
												...
												<div id="_type20">
													<label for="s-state" id="_type1">Type:</label> <select
														class="form-control" id="_type">
														<option value="">- select -</option>
												...
												<div id="_type21">
													<label for="s-state" id="_type11">Type:</label> <select
														class="form-control" id="_type01">
														<option value="">- select -</option>
														<option value="CA">Casuals</option>
														<option value="FL">FlipFlops</option>
														<option value="IL">Sneakers</option>
												...
												<div id="_type22">
													<label for="s-state" id="_type12">Type:</label> <select
														class="form-control" id="_type02">
														<option value="">- select -</option>
												...
												<div id="_price2">
													<label for="s-state" id="_price1">Price:</label> <select
														class="form-control" id="_price">
														<option value="">- select -</option>
												...
												<div id="_color2">
													<label for="s-state" id="_color1">Color:</label> <select
														class="form-control" id="_color">
														<option value="">- select -</option>
												...
												<div id="_mat2">
													<label for="s-state" id="_mat1">Materials:</label> <select
														class="form-control" id="_mat">
														<option value="">- select -</option>
												...
												<div id="_heel2">
													<!-- Heel HEight -->
													<label for="_heel" id="_heel1">Heel Height:</label> <select
														class="form-control " id="_heel">
														<option value="">- select -</option>
											...
											<!-- End row sub cat of cat -->
										</div>
										<!-- End row for main cat-->
